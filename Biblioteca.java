...
public class Biblioteca {
	...
	public void adicionarMaterial(Scanner scanner) {
		System.out.println("Gostaria de adicionar um livro ou uma revista?");
		...
		do {
			...
			if (tipo.equalsIgnoreCase("Revista")) {
				...
				Revistas revista = new Revistas(titulo, autor, edicao);
				...
				String autor = scanner.nextLine();
				System.out.print("Digite o código do gênero (1 = Ação, 2 = Comédia, 3 = Aventura): ");
	...
	void pesquisarMaterial(Scanner scanner) {
		System.out.println("Gostaria de pesquisar um livro ou uma revista?");
		do {
			String tipo = pergunta(scanner);
